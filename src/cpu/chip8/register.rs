...
impl From<GpRegisters> for u8 {
    fn from(src: GpRegisters) -> Self {
        // all usize values generated by GpRegisters will fit within a u8.
        std::convert::TryFrom::<usize>::try_from(src as usize).unwrap()
    }
}
